...
class MissingBrokenItemActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_missing_broken_item)
    ...
    private fun handleSubmitReport() {
        SubmitReportButton.setOnClickListener {
            ...
            if (reportTitle.isEmpty() || reportDescription.isEmpty()) {
                ...
                AddMissingBrokenItemReportToFirestore(
                    reportTitle,
                    reportDescription,
    ...
    private fun AddMissingBrokenItemReportToFirestore(
        Title: String,
        IssueDescription: String,
        UserLocation: String,
        ReportDestination: String
    ){
        val MissingBrokenItemReportContents = hashMapOf(
            "Title" to Title,
            "IssueDescription" to IssueDescription,
            "UserLocation" to UserLocation,
            "ReportDestination" to ReportDestination
        )
        db.collection("MissingBrokenItemReports")
            .add(MissingBrokenItemReportContents)
    }
